...
<body class="bg-gray-950">
    <header class="">
        <div class="shadow bg-gray-900 rounded-b-lg">
            <div class="h-16 mx-auto px-5 flex items-center justify-between">
              
                <a class="flex items-center h-12 hover:text-cyan-500 transition-colors cursor-pointer">
                    <img class="h-12" src="/images/bookin.png" alt=""><span class="ml-2 font-sans font-bold text-cyan-400">UBT Library</span></a>



                <ul class="flex text-white items-center gap-5">
                    @if (Route::has('login'))
                    <nav class=" flex flex-1 pr-2 justify-end">
                        @auth
                            <a
                                href="{{ url('/dashboard') }}"
    ...
    <section class="bg-white dark:bg-gray-950">
        <div class="grid max-w-screen-xl px-4 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12">
            <div class="mr-auto place-self-center lg:col-span-7">
                <h1 class="max-w-2xl mb-4 text-4xl font-extrabold leading-none md:text-5xl xl:text-6xl bg-gradient-to-r from-blue-600 via-white to-blue-300 inline-block text-transparent bg-clip-text">Manage your library online</h1>
            ...
            <div class="hidden lg:mt-0 lg:col-span-5 lg:flex">
                <img class="h-full" src="/images/tablet.png" alt="mockup">
            </div>                
        </div>
    </section>

    
    <section class="bg-gray-50 dark:bg-gray-950 rounded-t-2xl" >
    ...
    <footer class="p-4 bg-gray-50 sm:p-6 dark:bg-gray-900 rounded-t-xl">
